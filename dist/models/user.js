...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.create = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, saltrounds, hash, result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 2:
                        hash = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [user.username, hash])];
                    case 3:
                        result = _a.sent();
                        conn.release();
                    ...
                    case 4:
                        error_2 = _a.sent();
                        throw new Error("Cannot return new User ".concat(error_2));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Cannot return user with id ".concat(id));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("Cannot delete user of id ".concat(id));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.authenticate = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, user, correctPassword;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
