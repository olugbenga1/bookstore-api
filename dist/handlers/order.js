...
var orderBooks = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var bookOrder, addBook, error_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                bookOrder = req.body;
                return [4 /*yield*/, store.order_books(bookOrder)];
            case 1:
                addBook = _a.sent();
